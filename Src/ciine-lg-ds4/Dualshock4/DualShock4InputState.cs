...
{
    /// <summary>
    /// All available input variables for a DualShock4 controller.
    /// </summary>
    public class DualShock4InputState
    {
        /// <summary>
        /// Default constructor, initializes all fields to 0/false/default
        /// </summary>
        internal DualShock4InputState() { }

        /// <summary>
        /// Constructs a DualShock4InputState. Parses the HID input report.
        /// </summary>
        /// <param name="data">The data buffer.</param>
        /// <param name="inputMode">The DualShock4's input mode.</param>
        /// <param name="deadZone">The DualShock4's joystick deadzone.</param>
        internal DualShock4InputState(byte[] data, float deadZone)
        {
            // Analog inputs
            ...
            // Buttons
            byte btnBlock1 = GetModeSwitch(data, 4);
            byte btnBlock2 = GetModeSwitch(data, 5);
            byte btnBlock3 = GetModeSwitch(data, 6);
            ...
            byte miscByte = GetModeSwitch(data, 29); // this contains various stuff, seems to have both audio and battery info
