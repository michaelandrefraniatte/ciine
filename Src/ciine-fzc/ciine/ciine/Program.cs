                    ...
                    { 
                        ...
                        private void taskX()
                        {
                            for (; ; )
                            {
                                ...
                                controller1_send_X = wm.WiimoteButtonStateHome | ((wm.WiimoteRawValuesZ > 0 ? wm.WiimoteRawValuesZ : -wm.WiimoteRawValuesZ) >= 20f & (wm.WiimoteRawValuesY > 0 ? wm.WiimoteRawValuesY : -wm.WiimoteRawValuesY) >= 20f & (wm.WiimoteRawValuesX > 0 ? wm.WiimoteRawValuesX : -wm.WiimoteRawValuesX) >= 20f);
                                ...
                                controller1_send_Y = wm.WiimoteNunchuckStateRawValuesY > 33f | wm.WiimoteButtonStateUp;
