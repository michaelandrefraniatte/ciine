...
namespace DualSenseAPI.State
{
    ...
    public class DualSenseInputState
    {
        ...
        internal DualSenseInputState(byte[] data, float deadZone)
        {
            // Analog inputs
            ...
            // Buttons
            byte btnBlock1 = GetModeSwitch(data, 7);
            byte btnBlock2 = GetModeSwitch(data, 8);
            byte btnBlock3 = GetModeSwitch(data, 9);
            ...
            byte miscByte = GetModeSwitch(data, 53); // this contains various stuff, seems to have both audio and battery info
