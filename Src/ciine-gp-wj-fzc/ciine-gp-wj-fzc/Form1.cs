                    ...
                    { 
                        ...
                        private void taskX()
                        {
                            while (running)
                            {
                                ...
                                leftstick = JoyconLeftButtonSHOULDER_2 | JoyconLeftButtonSL | JoyconLeftButtonSR;
                                ...
                                leftbumper = WiimoteButtonStateMinus | WiimoteButtonStateLeft;
                                rightbumper = WiimoteButtonStatePlus | WiimoteButtonStateRight;
                                B = JoyconLeftButtonMINUS | JoyconLeftButtonCAPTURE;
                                Y = JoyconLeftAccelY <= -1.55f | WiimoteButtonStateUp;
