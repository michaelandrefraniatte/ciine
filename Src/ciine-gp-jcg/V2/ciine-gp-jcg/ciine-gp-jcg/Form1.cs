...
namespace ciine_gp_jcg
{
    public partial class Form1 : Form
    {
        ...
        private static bool ISLEFT = true, ISRIGHT = true;
        ...
        public void InitLeftJoycon()
        {
            try
            {
                stick_rawLeft[0] = jcg.report_bufLeft[6 + (ISLEFT ? 0 : 3)];
                stick_rawLeft[1] = jcg.report_bufLeft[7 + (ISLEFT ? 0 : 3)];
                stick_rawLeft[2] = jcg.report_bufLeft[8 + (ISLEFT ? 0 : 3)];
                ...
                acc_gcalibrationLeftX = (Int16)(jcg.report_bufLeft[13 + 0 * 12] | ((jcg.report_bufLeft[14 + 0 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufLeft[13 + 1 * 12] | ((jcg.report_bufLeft[14 + 1 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufLeft[13 + 2 * 12] | ((jcg.report_bufLeft[14 + 2 * 12] << 8) & 0xff00));
                acc_gcalibrationLeftY = (Int16)(jcg.report_bufLeft[15 + 0 * 12] | ((jcg.report_bufLeft[16 + 0 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufLeft[15 + 1 * 12] | ((jcg.report_bufLeft[16 + 1 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufLeft[15 + 2 * 12] | ((jcg.report_bufLeft[16 + 2 * 12] << 8) & 0xff00));
                acc_gcalibrationLeftZ = (Int16)(jcg.report_bufLeft[17 + 0 * 12] | ((jcg.report_bufLeft[18 + 0 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufLeft[17 + 1 * 12] | ((jcg.report_bufLeft[18 + 1 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufLeft[17 + 2 * 12] | ((jcg.report_bufLeft[18 + 2 * 12] << 8) & 0xff00));
            }
            catch { }
        }
        public void ProcessButtonsLeftJoycon()
        {
            try
            {
                ...
                acc_gLeft.X = ((Int16)(jcg.report_bufLeft[13 + 0 * 12] | ((jcg.report_bufLeft[14 + 0 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufLeft[13 + 1 * 12] | ((jcg.report_bufLeft[14 + 1 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufLeft[13 + 2 * 12] | ((jcg.report_bufLeft[14 + 2 * 12] << 8) & 0xff00)) - acc_gcalibrationLeftX) * (1.0f / 12000f);
                acc_gLeft.Y = -((Int16)(jcg.report_bufLeft[15 + 0 * 12] | ((jcg.report_bufLeft[16 + 0 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufLeft[15 + 1 * 12] | ((jcg.report_bufLeft[16 + 1 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufLeft[15 + 2 * 12] | ((jcg.report_bufLeft[16 + 2 * 12] << 8) & 0xff00)) - acc_gcalibrationLeftY) * (1.0f / 12000f);
                acc_gLeft.Z = -((Int16)(jcg.report_bufLeft[17 + 0 * 12] | ((jcg.report_bufLeft[18 + 0 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufLeft[17 + 1 * 12] | ((jcg.report_bufLeft[18 + 1 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufLeft[17 + 2 * 12] | ((jcg.report_bufLeft[18 + 2 * 12] << 8) & 0xff00)) - acc_gcalibrationLeftZ) * (1.0f / 12000f);
                JoyconLeftButtonSHOULDER_1 = (jcg.report_bufLeft[3 + (ISLEFT ? 2 : 0)] & 0x40) != 0;
                JoyconLeftButtonSHOULDER_2 = (jcg.report_bufLeft[3 + (ISLEFT ? 2 : 0)] & 0x80) != 0;
                JoyconLeftButtonSR = (jcg.report_bufLeft[3 + (ISLEFT ? 2 : 0)] & 0x10) != 0;
                JoyconLeftButtonSL = (jcg.report_bufLeft[3 + (ISLEFT ? 2 : 0)] & 0x20) != 0;
                JoyconLeftButtonDPAD_DOWN = (jcg.report_bufLeft[3 + (ISLEFT ? 2 : 0)] & (ISLEFT ? 0x01 : 0x04)) != 0;
                JoyconLeftButtonDPAD_RIGHT = (jcg.report_bufLeft[3 + (ISLEFT ? 2 : 0)] & (ISLEFT ? 0x04 : 0x08)) != 0;
                JoyconLeftButtonDPAD_UP = (jcg.report_bufLeft[3 + (ISLEFT ? 2 : 0)] & (ISLEFT ? 0x02 : 0x02)) != 0;
                JoyconLeftButtonDPAD_LEFT = (jcg.report_bufLeft[3 + (ISLEFT ? 2 : 0)] & (ISLEFT ? 0x08 : 0x01)) != 0;
                JoyconLeftButtonMINUS = (jcg.report_bufLeft[4] & 0x01) != 0;
                JoyconLeftButtonCAPTURE = (jcg.report_bufLeft[4] & 0x20) != 0;
                JoyconLeftButtonSTICK = (jcg.report_bufLeft[4] & (ISLEFT ? 0x08 : 0x04)) != 0;
                ...
                gyr_gLeft.X = ((Int16)(jcg.report_bufLeft[19 + 0 * 12] | ((jcg.report_bufLeft[20 + 0 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufLeft[19 + 1 * 12] | ((jcg.report_bufLeft[20 + 1 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufLeft[19 + 2 * 12] | ((jcg.report_bufLeft[20 + 2 * 12] << 8) & 0xff00)));
                gyr_gLeft.Y = ((Int16)(jcg.report_bufLeft[21 + 0 * 12] | ((jcg.report_bufLeft[22 + 0 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufLeft[21 + 1 * 12] | ((jcg.report_bufLeft[22 + 1 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufLeft[21 + 2 * 12] | ((jcg.report_bufLeft[22 + 2 * 12] << 8) & 0xff00)));
                gyr_gLeft.Z = ((Int16)(jcg.report_bufLeft[23 + 0 * 12] | ((jcg.report_bufLeft[24 + 0 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufLeft[23 + 1 * 12] | ((jcg.report_bufLeft[24 + 1 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufLeft[23 + 2 * 12] | ((jcg.report_bufLeft[24 + 2 * 12] << 8) & 0xff00)));
        ...
        public void InitRightJoycon()
        {
            try
            {
                stick_rawRight[0] = jcg.report_bufRight[6 + (!ISRIGHT ? 0 : 3)];
                stick_rawRight[1] = jcg.report_bufRight[7 + (!ISRIGHT ? 0 : 3)];
                stick_rawRight[2] = jcg.report_bufRight[8 + (!ISRIGHT ? 0 : 3)];
                ...
                acc_gcalibrationRightX = (Int16)(jcg.report_bufRight[13 + 0 * 12] | ((jcg.report_bufRight[14 + 0 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufRight[13 + 1 * 12] | ((jcg.report_bufRight[14 + 1 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufRight[13 + 2 * 12] | ((jcg.report_bufRight[14 + 2 * 12] << 8) & 0xff00));
                acc_gcalibrationRightY = (Int16)(jcg.report_bufRight[15 + 0 * 12] | ((jcg.report_bufRight[16 + 0 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufRight[15 + 1 * 12] | ((jcg.report_bufRight[16 + 1 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufRight[15 + 2 * 12] | ((jcg.report_bufRight[16 + 2 * 12] << 8) & 0xff00));
                acc_gcalibrationRightZ = (Int16)(jcg.report_bufRight[17 + 0 * 12] | ((jcg.report_bufRight[18 + 0 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufRight[17 + 1 * 12] | ((jcg.report_bufRight[18 + 1 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufRight[17 + 2 * 12] | ((jcg.report_bufRight[18 + 2 * 12] << 8) & 0xff00));
            }
            catch { }
        }
        public void ProcessButtonsRightJoycon()
        {
            try
            {
                ...
                acc_gRight.X = ((Int16)(jcg.report_bufRight[13 + 0 * 12] | ((jcg.report_bufRight[14 + 0 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufRight[13 + 1 * 12] | ((jcg.report_bufRight[14 + 1 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufRight[13 + 2 * 12] | ((jcg.report_bufRight[14 + 2 * 12] << 8) & 0xff00)) - acc_gcalibrationRightX) * (1.0f / 12000f);
                acc_gRight.Y = -((Int16)(jcg.report_bufRight[15 + 0 * 12] | ((jcg.report_bufRight[16 + 0 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufRight[15 + 1 * 12] | ((jcg.report_bufRight[16 + 1 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufRight[15 + 2 * 12] | ((jcg.report_bufRight[16 + 2 * 12] << 8) & 0xff00)) - acc_gcalibrationRightY) * (1.0f / 12000f);
                acc_gRight.Z = -((Int16)(jcg.report_bufRight[17 + 0 * 12] | ((jcg.report_bufRight[18 + 0 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufRight[17 + 1 * 12] | ((jcg.report_bufRight[18 + 1 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufRight[17 + 2 * 12] | ((jcg.report_bufRight[18 + 2 * 12] << 8) & 0xff00)) - acc_gcalibrationRightZ) * (1.0f / 12000f);
                JoyconRightButtonSHOULDER_1 = (jcg.report_bufRight[3 + (!ISRIGHT ? 2 : 0)] & 0x40) != 0;
                JoyconRightButtonSHOULDER_2 = (jcg.report_bufRight[3 + (!ISRIGHT ? 2 : 0)] & 0x80) != 0;
                JoyconRightButtonSR = (jcg.report_bufRight[3 + (!ISRIGHT ? 2 : 0)] & 0x10) != 0;
                JoyconRightButtonSL = (jcg.report_bufRight[3 + (!ISRIGHT ? 2 : 0)] & 0x20) != 0;
                JoyconRightButtonDPAD_DOWN = (jcg.report_bufRight[3 + (!ISRIGHT ? 2 : 0)] & (!ISRIGHT ? 0x01 : 0x04)) != 0;
                JoyconRightButtonDPAD_RIGHT = (jcg.report_bufRight[3 + (!ISRIGHT ? 2 : 0)] & (!ISRIGHT ? 0x04 : 0x08)) != 0;
                JoyconRightButtonDPAD_UP = (jcg.report_bufRight[3 + (!ISRIGHT ? 2 : 0)] & (!ISRIGHT ? 0x02 : 0x02)) != 0;
                JoyconRightButtonDPAD_LEFT = (jcg.report_bufRight[3 + (!ISRIGHT ? 2 : 0)] & (!ISRIGHT ? 0x08 : 0x01)) != 0;
                JoyconRightButtonPLUS = ((jcg.report_bufRight[4] & 0x02) != 0);
                JoyconRightButtonHOME = ((jcg.report_bufRight[4] & 0x10) != 0);
                JoyconRightButtonSTICK = ((jcg.report_bufRight[4] & (!ISRIGHT ? 0x08 : 0x04)) != 0);
                ...
                gyr_gRight.X = ((Int16)(jcg.report_bufRight[19 + 0 * 12] | ((jcg.report_bufRight[20 + 0 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufRight[19 + 1 * 12] | ((jcg.report_bufRight[20 + 1 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufRight[19 + 2 * 12] | ((jcg.report_bufRight[20 + 2 * 12] << 8) & 0xff00)));
                gyr_gRight.Y = ((Int16)(jcg.report_bufRight[21 + 0 * 12] | ((jcg.report_bufRight[22 + 0 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufRight[21 + 1 * 12] | ((jcg.report_bufRight[22 + 1 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufRight[21 + 2 * 12] | ((jcg.report_bufRight[22 + 2 * 12] << 8) & 0xff00)));
                gyr_gRight.Z = ((Int16)(jcg.report_bufRight[23 + 0 * 12] | ((jcg.report_bufRight[24 + 0 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufRight[23 + 1 * 12] | ((jcg.report_bufRight[24 + 1 * 12] << 8) & 0xff00)) + (Int16)(jcg.report_bufRight[23 + 2 * 12] | ((jcg.report_bufRight[24 + 2 * 12] << 8) & 0xff00)));
