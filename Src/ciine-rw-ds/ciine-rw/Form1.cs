        ...
        private string code = @"
                ...
                namespace StringToCode
                {
                    ...
                    { 
                        ...
                        private double statex = 0f, statey = 0f, mousex = 0f, mousey = 0f, mousestatex = 0f, mousestatey = 0f, dzx = 20.0f, dzy = 0.0f, viewpower1x = 0f, viewpower2x = 1f, viewpower3x = 0f, viewpower1y = 0.25f, viewpower2y = 0.75f, viewpower3y = 0f;
                        ...
                        private void taskX()
                        {
                            while (running)
                            {
                                ...
                                mousex = PS5ControllerAccelY * 31.25f;
